...
contract verifyOFT is ContractCodeChecker, Script, L2Constants, Test {
    ...
    function run() public {
        ...
        KingOFTUpgradeable tmpOFT = new KingOFTUpgradeable(DEPLOYMENT_LZ_ENDPOINT);
        ...
        TransparentUpgradeableProxy tmpProxy = new TransparentUpgradeableProxy(
            ...
            KingOFTUpgradeable.initialize.selector, TOKEN_NAME, TOKEN_SYMBOL, DEPLOYER_ADDRESS)
        );
        ...
        KingOFTUpgradeable oft = KingOFTUpgradeable(DEPLOYMENT_OFT);
