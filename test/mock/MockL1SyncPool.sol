...
contract MockL1SyncPool is OAppReceiverUpgradeable, ReentrancyGuardUpgradeable {
    ...
    error KingL1SyncPoolETH__OnlyETH();
    error KingL1SyncPoolETH__InvalidAmountIn();
    ...
    function onMessageReceived(
        ...
        if (tokenIn != 0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE) revert KingL1SyncPoolETH__OnlyETH();
        if (amountIn != msg.value) revert KingL1SyncPoolETH__InvalidAmountIn();
